...
public class SPUtils {
	...
	public static void put(String key, Object object){
		...
		put(BaseLibrary.newInstance().getContext(),key,object);
	}

	public static Object get(String key, Object object){
		return get(BaseLibrary.newInstance().getContext(),key,object);
	}
		...
		public static void apply(SharedPreferences.Editor editor) {
			try {
				if (sApplyMethod != null) {
					sApplyMethod.invoke(editor);// java的反射机制，现在还不是十分了解
					return;
				}
