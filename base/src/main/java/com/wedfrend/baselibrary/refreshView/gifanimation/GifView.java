...
/**
 * package com.welive.view.gifanimation 的主方法
 * 
 * 读取Gif图片的主类文件内容
 *
 * 这个类参照网上比较流行的GifView的第三方java包，我查看源码进行整理并备注原理
 *
 * 分享出来以方便大家理解
 *
 * 自定义View类，需重写   onMeasure（），onDraw()有时候需要重写onLayout（）方法
 *
...
public class GifView extends View implements GifAction {
	 ...
	 * 
	 */
	public void setStopGifDecoderImage(){
		if (gifDecoder != null) {
			gifDecoder.stop();
			gifDecoder.free();
			gifDecoder = null;
